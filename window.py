...
class AppWindow(QMainWindow):
    ...
    def show_info(self, target_widget, new_info):
        ...
        elif isinstance(target_widget, QPlainTextEdit):
            pass
    ...
    def delete_label(self):
        try:
            if self.selected_saved_rect_index != -1:
                ...
                self.save_label(1)
                #TODO: shouldn't save unsaved rect here! only save saved rects.
    ...
    def apply_category(self):
        ...
        #self.current_category_index = self.current_row
        #self.current_category_name = self.current_item_content
    ...
    def choose_color(self):
        ...
        if color.isValid() and self.current_category_index != -1:
            ...
            #item = self.ui.tableWidget_categories.item(self.current_category_index, 0)
            #brush = QBrush(self.category_color_dic[self.current_category_id])
            #item.setBackground(QBrush(QColor(255, 0, 0, 127)))
            #TODO: cannot use category index, use header content!
    ...
    def add_category(self):
        ...
        #self.show_info(self.ui.plainTextEdit_statusBar, str(row_numbers))
    ...
    #TODO: every time open a new file or dir, clear savedrects, unsavedrects and selectedrect.     
    ...
    def save_category_name(self):  #TODO: add arg: path
        name_list = []
        row_no = self.ui.tableWidget_categories.rowCount()
    ...
    def save_bbox_ratio(self):
        if self.bbox_pos_x_ratio >= 0 and self.bbox_pos_y_ratio >= 0:
            lst = []
            _lst = []
            #TODO: append last used category
            if self.current_category_id != -1:
        ...
        if self.unsaved_rects:
            for item in self.unsaved_rects:
                if int(item[0]) > -1:
                    ...
                    # TODO: allow user to draw rect first, then choose category.
